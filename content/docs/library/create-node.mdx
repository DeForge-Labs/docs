...
<Accordions type="single">
    ...
    <Accordion title="openrouterUtil">
        ...
        - `getModelPricing(model: string): Promise<modelPricingResponse>`:
            ...
            <TypeTable
                type={{
                    model: {
                        description: 'model name in openrouter family/slug format',
                        type: 'string',
                        required: true,
                    },
                }}
            />
            ### Returns [!toc]
            Promise with model pricing information including price details, and message
            <TypeTable
                type={{
                    message: {
                        type: 'string',
                    ...
                    inputTokenCostPerToken: {
                        type: 'number',
                        required: true,
                    },
                    outputTokenCostPerToken: {
                        type: 'number',
                        required: true,
                    },
                }}
