...
<Accordions type="single">
    ...
    <Accordion title="Auth Nodes">
        These nodes provide authentication and authorization features for your workflows. Examples include Passwordless OTP Generate and Verify nodes.
    </Accordion>
    ...
    <Accordion title="GenAI Nodes">
        These nodes provide generative AI capabilities for creating images, music, and videos. Examples include the Imagen AI Images node, Lyria AI Music node, and Veo AI Video node.
    </Accordion>
