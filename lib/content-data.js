  ...
  },
  {
    ...
    sections: [
        ...
        subsections: [
          {
            ...
            content:
              "A sandbox environment for building and testing your agent. Changes made here don't affect users of your production agent.",
          },
          {
            id: "staging",
            title: "Staging Environment",
            content:
              "An intermediate environment that mimics production but is only accessible to your team. Use this to test changes before releasing them to users.",
          },
          {
            id: "production",
            title: "Production Environment",
            content:
              "The live environment where your agent is available to end users. Changes to production should be carefully tested in development and staging first.",
          },
        ],
      },
      {
      ...
      },
      {
        ...
        title: "Next Steps",
        content:
          "Now that you know how to deploy your AI agents, explore our [Example Projects](/examples) for inspiration on what you can build with Deforge.",
      },
    ],
  },
];
