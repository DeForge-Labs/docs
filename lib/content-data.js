...
export const docPages = [
  ...
  },
  {
    ...
    sections: [
      ...
      {
        id: "add-telegram-trigger",
        title: "Step 2: Add a Telegram Trigger Node",
        content:
        ...
        subsections: [
          {
            id: "configure-telegram-trigger",
            title: "Configure the Telegram Trigger",
            content:
      ...
      },
      {
        ...
        title: "Step 3: Add a Knowledge Base Node",
        content:
        ...
        subsections: [
          {
            id: "configure-knowledge-base",
            title: "Configure the Knowledge Base",
            content:
      ...
      {
        id: "add-telegram-sender",
        title: "Step 5: Add a Send Telegram Message Node",
        content:
          "Finally, add a 'Send Telegram Message' node to send the AI's response back to the user on Telegram.",
        subsections: [
          {
            id: "configure-telegram-sender",
            title: "Configure the Send Message Node",
            content:
      ...
      {
        id: "connect-nodes",
        title: "Step 6: Connect the Nodes",
        content:
      ...
      {
        id: "deploy-agent",
        title: "Step 8: Deploy Your Agent",
        content:
      ...
      },
      {
        ...
        title: "Next Steps",
        content:
          "Congratulations on building your first AI agent! You've created a sophisticated Telegram bot that can answer questions using a knowledge base. Try enhancing your bot by adding more knowledge sources, implementing different trigger conditions, or integrating with other services. Explore our [Node Reference](/docs/nodes) to discover more nodes and capabilities, or check out our [Templates](https://deforge.io/templates) for more advanced workflows.",
      },
    ],
  },
  {
