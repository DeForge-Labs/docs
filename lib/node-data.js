...
export const categories = [
  ...
  },
  {
    id: "GenAI",
    name: "Gen AI Nodes",
    description: "Nodes that interact with Generative AI models to create content",
    icon: "MonitorPlay",
  },
  {
    id: "flow",
  ...
  {
    id: "social",
    name: "Social Media Nodes",
    description: "Nodes that interact with social media platforms",
    icon: "Youtube",
  },
  {
    id: "search",
    name: "Search Nodes",
    description: "Nodes that allow to search for information on the Web",
    icon: "Search",
  },
  {
    id: "office",
    name: "Office Nodes",
    description: "Nodes that interact with office productivity tools",
    icon: "Briefcase",
  },
  {
    id: "audio",
    name: "Audio Nodes",
    description: "Nodes that process and generate audio content",
    icon: "Mic",
  },
  {
    id: "trigger",
...
export const nodeData = [
  ...
  },
  {
    ...
    "longDescription": "A True/False binary value node meant for logical operations",
    "useCases": [
  ...
  },
  {
    ...
    "longDescription": "Send media files via telegram bot.",
    "useCases": [
  ...
  },
  {
    ...
    "longDescription": "Create a text post on twitter / X via your agent",
    "useCases": [
